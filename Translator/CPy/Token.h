...
namespace Translator {
	enum class Type {
		...
		TYPEDEF, CHAR, SHORT, INT, LONG, SIGNED, UNSIGNED,
		FLOAT, DOUBLE, VOID, STRUCT, ENUM, CASE, DEFAULT,
		IF, ELSE, SWITCH, WHILE, DO, FOR, BREAK, RETURN,
		other, none, parsing, eof, error
	};
